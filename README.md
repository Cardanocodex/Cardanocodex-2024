...
Welcome to [**CardanoCodex'24 Hackathon**](https://cardanocodex.xyz) powered by [**Nucast Labs**](https://nucast.io/)
...
[create an issue](https://github.com/Cardanocodex/Cardanocodex-2024/issues) in the main repository as:
